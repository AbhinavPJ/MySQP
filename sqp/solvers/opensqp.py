...
from modopt.line_search_algorithms import Minpack2LS #type:ignore
from modopt.merit_functions import AugmentedLagrangian #type:ignore
from modopt.approximate_hessians import BFGSScipy #type:ignore
from modopt import CSDLAlphaProblem #type:ignore
...
class OpenSQP(Optimizer):
    ...
    def solve(self):
        ...
        try:
            from quadprog import solve_qp  #type:ignore
        except ImportError:
